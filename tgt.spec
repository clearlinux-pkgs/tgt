...
Version  : 1.0.78
Release  : 41
URL      : https://github.com/fujita/tgt/archive/v1.0.78/tgt-1.0.78.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.78/tgt-1.0.78.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1559580210
export AR=gcc-ar
