...
Version  : 1.0.83
Release  : 46
URL      : https://github.com/fujita/tgt/archive/v1.0.83/tgt-1.0.83.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.83/tgt-1.0.83.tar.gz
...
%prep
%setup -q -n tgt-1.0.83
cd %{_builddir}/tgt-1.0.83
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654271342
...
cp %{_builddir}/tgt-1.0.83/LICENSE %{buildroot}/usr/share/package-licenses/tgt/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/tgt-1.0.83/scripts/deb/copyright %{buildroot}/usr/share/package-licenses/tgt/0017da1fb3304b439bdc64f2a6a7801c41790384
%make_install
