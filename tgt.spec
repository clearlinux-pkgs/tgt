...
Version  : 1.0.85
Release  : 48
URL      : https://github.com/fujita/tgt/archive/v1.0.85/tgt-1.0.85.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.85/tgt-1.0.85.tar.gz
...
%prep
%setup -q -n tgt-1.0.85
cd %{_builddir}/tgt-1.0.85
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672695272
