...
Version  : 1.0.93
Release  : 56
URL      : https://github.com/fujita/tgt/archive/v1.0.93/tgt-1.0.93.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.93/tgt-1.0.93.tar.gz
...
%prep
%setup -q -n tgt-1.0.93
cd %{_builddir}/tgt-1.0.93
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a tgt-1.0.93 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725460219
