...
Version  : 1.0.77
Release  : 40
URL      : https://github.com/fujita/tgt/archive/v1.0.77/tgt-1.0.77.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.77/tgt-1.0.77.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1556983696
export AR=gcc-ar
