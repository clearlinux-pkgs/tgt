...
Version  : 1.0.91
Release  : 54
URL      : https://github.com/fujita/tgt/archive/v1.0.91/tgt-1.0.91.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.91/tgt-1.0.91.tar.gz
...
%prep
%setup -q -n tgt-1.0.91
cd %{_builddir}/tgt-1.0.91
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a tgt-1.0.91 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709419227
