...
Version  : 1.0.90
Release  : 53
URL      : https://github.com/fujita/tgt/archive/v1.0.90/tgt-1.0.90.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.90/tgt-1.0.90.tar.gz
...
%prep
%setup -q -n tgt-1.0.90
cd %{_builddir}/tgt-1.0.90
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a tgt-1.0.90 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704299715
