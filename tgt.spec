...
Version  : 1.0.84
Release  : 47
URL      : https://github.com/fujita/tgt/archive/v1.0.84/tgt-1.0.84.tar.gz
Source0  : https://github.com/fujita/tgt/archive/v1.0.84/tgt-1.0.84.tar.gz
...
%prep
%setup -q -n tgt-1.0.84
cd %{_builddir}/tgt-1.0.84
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659714132
